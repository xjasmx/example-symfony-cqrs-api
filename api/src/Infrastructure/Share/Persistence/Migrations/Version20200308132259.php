 ...
 */
final class Version20200308132259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id UUID NOT NULL, email VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, changed_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name_first VARCHAR(255) NOT NULL, name_last VARCHAR(255) DEFAULT NULL, status_type VARCHAR(255) NOT NULL, confirm_token_value VARCHAR(255) DEFAULT NULL, confirm_token_expires TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9E7927C74 ON users (email)');
        $this->addSql('COMMENT ON COLUMN users.changed_on IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN users.created_on IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE oauth2_client (identifier VARCHAR(32) NOT NULL, secret VARCHAR(128) DEFAULT NULL, redirect_uris TEXT DEFAULT NULL, grants TEXT DEFAULT NULL, scopes TEXT DEFAULT NULL, active BOOLEAN NOT NULL, PRIMARY KEY(identifier))');
