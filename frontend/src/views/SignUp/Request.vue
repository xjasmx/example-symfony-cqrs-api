            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <b-form @submit="signup">
                        ...
                        <b-form-group label="First Name" label-for="signupFirstName">
                            <b-form-input
                                    id="signupName"
                                    type="text"
                            ...
                            <b-form-invalid-feedback id="signupFirstNameError">{{ errors.first_name }}
                            </b-form-invalid-feedback>
                        </b-form-group>

                        <b-form-group label="LastName" label-for="signupLastName">
                            <b-form-input
                                    id="signupLastName"
                                    type="text"
                                    v-model="form.last_name"
                                    aria-describedby="signupFirstLastNameError"
                                    :state="errors.email ? false : null"
                                    required>
                            </b-form-input>
                            <b-form-invalid-feedback id="signupFirstLastNameError">{{ errors.last_name }}
                            </b-form-invalid-feedback>
                        </b-form-group>
